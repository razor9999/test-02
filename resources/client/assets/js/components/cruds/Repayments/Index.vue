...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Loan', field: 'loan', tdComp: DatatableSingle },
    ...
    computed: {
        ...mapGetters('RepaymentsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('RepaymentsIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
